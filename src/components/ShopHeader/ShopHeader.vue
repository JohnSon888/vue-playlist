    ...
    <transition name="fade">
      <div class="activity-sheet" v-show="supportShow">
        <div class="activity-sheet-content">
          ...
          <ul class="list">
            <li class="activity-item " :class="supportClasses[support.type]" v-for="(support,index) in info.supports">
              <span class="content-tag">
...
export default {
  data() {
    return {
      supportClasses:  ['activity-green', 'activity-red', 'activity-orange'], //优惠类名动态加载
      shopShow: false,
      supportShow: false,
    };
  },
